                ...
                <div class="col-xs-12">
                  ...
                  <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Sessions 1 (Slide)</h3>
                  ...
                  <div class="box">
                    ...
                    <div class="box-body">
                      <table id="" class="table table-bordered table-striped">
                        <thead>
                          <tr>
                            <th hidden class="center" style="vertical-align:middle;" width=5px>
                                <label class="pos-rel">
                                    <input type="checkbox" class="ace" />
                                    <span class="lbl"></span>
                                </label>
                        ...
                        <tbody>
                           <?php foreach ( $sql_menu1_segment3 as $row_segment){ 
                            ...
                            ?> 
                          <tr>
                            <td hidden class="center" style="vertical-align:middle;">
                                <label class="pos-rel">
                                    <input type="checkbox" class="ace" name="id[]" value="<?= $row_segment->id; ?>" />
                                    <span class="lbl"></span>
                                </label>
...
-->
                  ...
                  <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Sessions 5</h3>
                       <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                       </div>
                    </div><!-- /.box-header -->
                    ...
                    <div class="box-body"> 
                      ...
                      <div class="row">
                          ...
                          <div class="col-xs-2">
                              <a href="<?php echo base_url() . 'menu/add/'.$menu.'_'.$segment5.'/'.$menu.'/'.$title; ?>" class="btn btn-sm btn-block btn-success">Add</a>
                          </div>
                      </div>
                   </div><!-- /.box-body -->
                 </form><!--/form-->
                 ...
                 <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Sessions 6</h3>
                       <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                       </div>
                    </div><!-- /.box-header -->
                    ...
                    <div class="box-body"> 
                      ...
                      <div class="row">
                          ...
                          <div class="col-xs-2">
                              <a href="<?php echo base_url() . 'menu/add/'.$menu.'_'.$segment6.'/'.$menu.'/'.$title; ?>" class="btn btn-sm btn-block btn-success">Add</a>
                          </div>
                      </div>
                    </div>
                  ...
                  <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Sessions 7</h3>
                       <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                       </div>
                    </div><!-- /.box-header -->
                    ...
                    <div class="box-body"> 
                      ...
                      <div class="row">
                          ...
                          <div class="col-xs-2">
                              <a href="<?php echo base_url() . 'menu/add/'.$menu.'_'.$segment7.'/'.$menu.'/'.$title; ?>" class="btn btn-sm btn-block btn-success">Add</a>
                          </div>
                      </div>
                                  ...
                                  <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Sessions 8</h3>
                       <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                       </div>
                    </div><!-- /.box-header -->
                    ...
                    <div class="box-body"> 
                      ...
                      <div class="row">
                          ...
                          <div class="col-xs-2">
                              <a href="<?php echo base_url() . 'menu/add/'.$menu.'_'.$segment8.'/'.$menu.'/'.$title; ?>" class="btn btn-sm btn-block btn-success">Add</a>
                          </div>
                      </div>
                </div>
