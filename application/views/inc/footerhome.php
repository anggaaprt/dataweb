...
<script src="<?= base_url('assets/home'); ?>/js/jquery.scrollTo.js"></script>
<script src="<?= base_url('assets/home'); ?>/js/jquery.nav.js"></script>
<script src="<?= base_url('assets/home'); ?>/js/jquery.localscroll-1.2.7-min.js"></script>
...
<script src="<?= base_url('assets/home'); ?>/js/inview.js"></script>
