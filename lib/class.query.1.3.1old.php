...
class ClassQuery{
		...
		function showImages($dir, $kode, $width, $height){
			...
			if ($type == "") {
					...
					$picture	= '<img src="'.$dir.$kode.'.'.$type.'" width="'.$width.'"  height="'.$height.'" border="0"/>';				
				}				
			return $picture;
		}
